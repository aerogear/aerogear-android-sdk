 ...
 * only.
 */
public final class FireMeIfMergedConnectionBuilder  implements ConnectionBuilder {

    public static final FireMeIfMergedConnectionBuilder INSTANCE = new FireMeIfMergedConnectionBuilder();
    ...
    public FireMeIfMergedConnectionBuilder() {
