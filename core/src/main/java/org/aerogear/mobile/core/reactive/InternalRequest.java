 ...
 * allow us to tightly couple implementation details of the various proxies, wrappers, delegates, etc
 * without exposing that implementation detail to outside packages.
 *
 * Unless you are adding classes to the org.aerogear.mobile.core.reactive package please us {@link Request} instead.
 *
...
interface InternalRequest<T> extends Request<T> {
     ...
     * to deal with.
     *
     * @param responderRef a reference to the responder.  This reference may become null if the responder is
     *                     disconnected.
